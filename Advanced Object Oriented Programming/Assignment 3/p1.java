...
class EmployeeList{
    ...
    void displayEmployee(int c, DepartmentList e){
        ...
        if((i = ifExists(c))!= -1){
            ...
            System.out.println(e.list.get(ifExists(list.get(i).deptcode))); 
...
class Test123{
    ...
    void run(){
        ...
        choice = sc.nextInt();
        switch(choice){
            case 1 :  e.addEmployee(d);break;
            case 2 : System.out.println("Enter the employee code : ");
            int c = sc.nextInt(); 
            e.removeEmployee(c);
            break;
            case 3 : d.addDepartment();break;
            case 4 :  System.out.println("Enter the employee code : ");
            k = sc.nextInt(); 
            e.displayEmployee(k, d);
            break;
            case 5 : e.displayList();break;
            case 6 :  System.out.println("Enter the department code : ");
            k = sc.nextInt(); 
            Department d = new Department();
            d.setCode(k);
            System.out.println("Total Basic pay : " + d.totalPay(e));
            break;
            case 7 : System.out.println("Enter employee code : ");  
            k = sc.nextInt();
            System.out.println("Enter new basic pay  : ");  
            double pay = sc.nextDouble();
            e.modifyBasic(k, pay);
            break;
            case 8 : System.out.println("Sort according to \n1. Basic pay\n2. Employee code\n3. Department code\n");
            k = sc.nextInt();
            if(k == 1){
                e.sortBasic();
            }
